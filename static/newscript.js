...
var Note = {
    ...
    createNote: function(){
        ...
        iconsDelete.addEventListener('click',Note.removeNote());
        iconsCheck.addEventListener('click',Note.noteComplete());
        iconsEdit.addEventListener('click',Note.noteEdit());
